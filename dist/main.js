...
var author$project$Main$stepHome = F2(
	function (model, _n0) {
		...
		return _Utils_Tuple2(
			...
			A2(elm$core$Platform$Cmd$map, author$project$Main$HomeMsg, homeMsg));
	});
var author$project$Main$Products = function (a) {
	return {$: 'Products', a: a};
};
var author$project$Main$ProductsMsg = function (a) {
	return {$: 'ProductsMsg', a: a};
};
var author$project$Main$stepProducts = F2(
	function (model, _n0) {
		var productsModel = _n0.a;
		var productsMsg = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$Products(productsModel)
				}),
...
var author$project$Page$Products$init = function (_n0) {
	return _Utils_Tuple2(author$project$Page$Products$initModel, author$project$Page$Products$loadProducts);
};
...
var author$project$Main$getRoute = function (model) {
...
var author$project$Main$getPage = F2(
	function (model, url) {
		var _n0 = A2(
			...
			author$project$Main$getRoute(model),
			url);
		if (_n0.$ === 'Just') {
			var answer = _n0.a;
			return answer;
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UrlChanged':
				var url = msg.a;
				return A2(author$project$Main$getPage, model, url);
			case 'LinkClicked':
			...
			case 'ProductsMsg':
				var productsMsg = msg.a;
				var _n2 = model.page;
				if (_n2.$ === 'Products') {
					var productsModel = _n2.a;
					return A2(
						author$project$Main$stepProducts,
						model,
						A2(author$project$Page$Products$update, productsMsg, productsModel));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'HomeMsg':
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$href('/products')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('collection-item'),
								elm$html$Html$Attributes$href('/components')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('components')
...
var author$project$Page$NotFound$view = function (_n0) {
	return {
		content: _List_fromArray(
			[
				A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$core$List$isEmpty(model.products) ? A2(
						elm$html$Html$div,
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('cart-panel')
						...
						_List_fromArray(
							[
								elm$html$Html$text('no products')
							])) : author$project$Page$Products$viewProducts(model.products)
					]))
			]),
		title: 'Products Page'
	};
...
var author$project$PageLayout$viewFooter = A2(
...
var author$project$PageLayout$viewHeader = A2(
	elm$html$Html$nav,
	_List_Nil,
	_List_fromArray(
		[
...
var author$project$PageLayout$view = F2(
	function (toMsg, pageData) {
		return {
			body: _List_fromArray(
				[
					author$project$PageLayout$viewHeader,
					A2(
					elm$html$Html$map,
					toMsg,
					A2(elm$html$Html$div, _List_Nil, pageData.content)),
					author$project$PageLayout$viewFooter
				]),
